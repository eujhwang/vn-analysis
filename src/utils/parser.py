...
def register_default_args(parser, ident):
    ...
    parser.add_argument('--vns_conn', type=int, default=1)  # is ignored (always considered 1) with graclus currently
    ...
    # virtual nodes
    parser.add_argument('--JK', type=str, default="sum", choices=["last", "sum"], help="how to combine nodes at the end")
    parser.add_argument('--activation', type=str, default="leaky", choices=["relu", "leaky", "elu"],
