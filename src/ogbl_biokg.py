...
def main(args):
    if args.no_train and args.no_valid and args.no_test and args.evaluate_train:
    ...
    dataset_id, args.model, args.hidden_dim, args.gamma, timestamp) if args.save_path == None else args.save_path
    ...
    if not args.no_train:
        ...
        for step in range(init_step, args.max_steps):
            ...
            if not args.no_valid and step % args.valid_steps == 0 and step > 0:
